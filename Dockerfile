...
#
# Single image serving BOTH transports of the vgi-etf-globalx worker:
...
ARG SOURCE_URL=https://github.com/Query-farm/vgi-etf-globalx

LABEL org.opencontainers.image.title="vgi-etf-globalx" \
      org.opencontainers.image.description="Global X US ETF data as a VGI worker for DuckDB/SQL (stdio + HTTP)" \
